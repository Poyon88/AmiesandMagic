...
import TopdeckCostOverlay from "./TopdeckCostOverlay";
...
export default function GameBoard({ onAction, onMulliganRevealDone, opponentMulliganRevealDone = false }: GameBoardProps) {
  ...
  return (
    ...
    >
      ...
      <TopdeckCostOverlay event={topdeckCostEvent} onComplete={clearTopdeckCostEvent} />
      ...
      <EpargneGainOverlay kind="exploration" event={explorationGainEvent} onComplete={clearExplorationGainEvent} />
