...
export default function CardForge() {
  ...
  const generateTokenPrompt = useCallback(() => {
    ...
    const tokenVisualDescriptions: Record<string, string> = {
      ...
      "Griffons": "a majestic griffin with the head and wings of an eagle and the body of a lion, golden-brown feathers, tawny fur, powerful talons",
      "Faucons": "a swift falcon with sleek pointed wings, sharp hooked beak, keen amber eyes, slate-grey and cream barred plumage",
