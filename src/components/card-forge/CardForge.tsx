...
export default function CardForge() {
  ...
  const generateTokenPrompt = useCallback(() => {
    ...
    const tokenVisualDescriptions: Record<string, string> = {
      ...
      "Farfadets": "a small mischievous leprechaun, red-cheeked face under a wide green felt hat, buckled shoes, clay pipe, gold coins spilling from a pouch, sly grin",
      "Korrigans": "a stunted korrigan sprite, gnarled bark-like skin, oversized ears, tangled mossy hair strung with dolmen charms, squat and stubborn under moonlight",
      "Faunes": "a woodland faun, human torso above shaggy goat legs and cloven hooves, curling ram horns, reed panpipes at the lips, ivy in the hair",
      "Dryades": "a woodland dryad, feminine figure with skin of smooth living bark streaked with sap, hair of leaves and blossom, roots trailing from the feet, half-emerged from an ancient oak",
      ...
      "Hommes-Singes": "a simian humanoid with ape features, long powerful arms, expressive face, dense fur, agile and cunning",
      "Éléphants": "a massive war elephant, thick grey hide, long tusks reinforced with metal caps, armored howdah and battle harness",
      "Hommes-Poissons": "an aquatic humanoid with fish features, iridescent scales, webbed hands, gill slits, fins along the arms",
      "Hommes-Oiseaux": "an avian humanoid with bird features, feathered body, sharp beak, taloned feet, folded wings",
      ...
      "La Colère des Flammes": "a fire elemental, body made of living flames, molten core, embers floating around",
      "Le Socle du Monde": "an earth elemental, body of rock and stone, crystal growths, moss patches, heavy and immovable",
      "La Vague Sans Fin": "a water elemental, body of flowing translucent water, whirlpool core, droplets suspended in air",
      "Le Souffle des Cimes": "a storm elemental, body of swirling wind and lightning, crackling electricity, semi-transparent",
      ...
      "Ondins": "an undine reef warrior, blue-green scaled humanoid with finned forearms and a crested head, coral-plated armour, long barbed trident, water streaming from the shoulders",
      "Sirènes": "a siren enchantress, humanoid torso above a long iridescent fish tail, wet flowing hair strung with pearls, webbed hands raised mid-song, hypnotic pale eyes",
      "Léviathans": "a colossal leviathan of the abyss, immense serpentine sea beast breaching, barnacle-crusted armoured hide, cavernous toothed maw, ridged dorsal fins",
