...
export async function POST(request: Request) {
  ...
  const raceVisualDescriptions: Record<string, string> = {
    ...
    "Griffons": "majestic griffin with the head and wings of an eagle and the body of a lion, golden-brown plumage, tawny fur, razor talons",
    "Faucons": "swift war falcon, sleek grey-and-cream barred plumage, keen dark eyes, hooked beak, pointed wings built for speed",
    // Hommes-Bêtes
