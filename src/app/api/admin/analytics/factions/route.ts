...
import { aggregateByCardAttribute, fetchCards, fetchSnapshots, Period } from '@/lib/admin/analytics';
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const stats = aggregateByCardAttribute(snapshots, cards, 'faction', minGames);
