...
export const FACTIONS: Record<string, {
  ...
  Humains: {
    ...
    // Griffons et Faucons : bêtes ailées des Royaumes Libres. Le groupe de
    // clans étant `appliesTo: "all"`, elles accèdent aux quatre clans.
    ...
    forbiddenKeywords: ["Poison", "Corruption", "Maléfice", "Pacte de sang", "Nécrophagie"],
    description: "Le vieux continent : honneur, acier, champions héroïques et bêtes ailées des bannières.",
    raceProfiles: {
      "Griffons": { statWeights: { atk: 1.20, def: 1.05 }, likelyKeywords: { "Vol": 0.90, "Bravoure": 0.55, "Première Frappe": 0.50, "Loyauté": 0.45, "Provocation": 0.35, "Bouclier": 0.30 } },
      "Faucons": { statWeights: { atk: 1.15, def: 0.70 }, likelyKeywords: { "Vol": 0.90, "Célérité": 0.55, "Traque": 0.55, "Précision": 0.50, "Esquive": 0.45, "Première Frappe": 0.40 } },
    },
    clanProfiles: {
