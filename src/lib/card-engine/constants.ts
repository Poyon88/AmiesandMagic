...
export const FACTIONS: Record<string, {
  ...
  Humains: {
    ...
    // Bêtes ailées des Royaumes Libres : comme les Aigles Géants chez les
    // Elfes, elles volent aux côtés de tous les clans humains.
    freeRaces: ["Griffons", "Faucons"],
    ...
    raceProfiles: {
      "Griffons": { statWeights: { atk: 1.25, def: 1.05 }, likelyKeywords: { "Vol": 0.90, "Bravoure": 0.50, "Première Frappe": 0.50, "Traque": 0.45, "Loyauté": 0.40, "Provocation": 0.30 } },
      "Faucons": { statWeights: { atk: 1.15, def: 0.70 }, likelyKeywords: { "Vol": 0.90, "Célérité": 0.55, "Précision": 0.55, "Traque": 0.50, "Esquive": 0.45, "Première Frappe": 0.40 } },
    },
    clanProfiles: {
