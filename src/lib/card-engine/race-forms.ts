...
export const RACE_FORMS_FR: Record<string, Inflected> = {
  ...
  "Momies": { def: "la Momie", bare: "Momie", de: "de la Momie" },
  "Chimères nécrotiques": { def: "la Chimère nécrotique", bare: "Chimère nécrotique", de: "de la Chimère nécrotique" },
  "Vermines mortuaires": { def: "la Vermine mortuaire", bare: "Vermine mortuaire", de: "de la Vermine mortuaire" },
  "Poltergeists": { def: "le Poltergeist", bare: "Poltergeist", de: "du Poltergeist" },
  "Dullahans": { def: "le Dullahan", bare: "Dullahan", de: "du Dullahan" },
  "Sluaghs": { def: "le Sluagh", bare: "Sluagh", de: "du Sluagh" },
  "Ondins": { def: "l'Ondin", bare: "Ondin", de: "de l'Ondin" },
  "Sirènes": { def: "la Sirène", bare: "Sirène", de: "de la Sirène" },
  "Léviathans": { def: "le Léviathan", bare: "Léviathan", de: "du Léviathan" },
  "Cristallins": { def: "le Cristallin", bare: "Cristallin", de: "du Cristallin" },
  "Troglodytes": { def: "le Troglodyte", bare: "Troglodyte", de: "du Troglodyte" },
  "Bêtes Chtoniennes": { def: "la Bête Chtonienne", bare: "Bête Chtonienne", de: "de la Bête Chtonienne" },
  "Salamandres": { def: "la Salamandre", bare: "Salamandre", de: "de la Salamandre" },
  "Sylphes": { def: "le Sylphe", bare: "Sylphe", de: "du Sylphe" },
  "Néphélides": { def: "la Néphélide", bare: "Néphélide", de: "de la Néphélide" },
  "Banshees": { def: "la Banshee", bare: "Banshee", de: "de la Banshee" },
  "Homuncules de Sang": { def: "l'Homuncule de Sang", bare: "Homuncule de Sang", de: "de l'Homuncule de Sang" },
  "Gargouilles": { def: "la Gargouille", bare: "Gargouille", de: "de la Gargouille" },
  "Dhampirs": { def: "le Dhampir", bare: "Dhampir", de: "du Dhampir" },
  "Chiroptères": { def: "le Chiroptère", bare: "Chiroptère", de: "du Chiroptère" },
