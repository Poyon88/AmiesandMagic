...
export const ALL_KEYWORDS: Keyword[] = [
  ...
  "canalisation", "contresort", "convocation", "convocation_simple", "malediction", "necrophagie", "richesse",
...
export const KEYWORD_LABELS: Record<Keyword, string> = {
  ...
  malediction: "Malédiction", necrophagie: "Nécrophagie", richesse: "Richesse X",
...
export const KEYWORD_SYMBOLS: Record<Keyword, string> = {
  ...
  convocation_simple: "📯",
  malediction: "💀", necrophagie: "🦴", richesse: "🤑",
