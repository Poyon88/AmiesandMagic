...
export const ALL_KEYWORDS: Keyword[] = [
  ...
  "soleil",
  "pauvrete",
  "inspiration", "afflux", "epargne", "foi", "conquete", "exploration", "seconde_vie", "incineration", "devoration", "creuser", "retour_differe",
  "concentration",
  "remontee",
...
export const KEYWORD_LABELS: Record<Keyword, string> = {
  ...
  impact: "Impact X",
  inspiration: "Inspiration X", afflux: "Afflux X", epargne: "Épargne X", foi: "Foi X", conquete: "Conquête X", exploration: "Exploration X",
  ...
  fortifier: "Fortifier +X/+Y",
  preincanter: "Préincanter X",
  conferer: "Conférer",
...
export const KEYWORD_SYMBOLS: Record<Keyword, string> = {
  ...
  pillage: "💰", riposte: "↩️", chant: "🎵", lune: "🌙", soleil: "☀️",
  rappel: "🔄", combustion: "🔥",
  ...
  apprentissage: "📖",
  impact: "💥",
  inspiration: "📖", afflux: "💎", epargne: "🪙", foi: "✨", conquete: "🚩", exploration: "🧭",
