...
- GLOSSARY — the card type called « action » in French (formerly « sort ») is translated EXACTLY as: English "Action", Spanish "Acción", German "Aktion", Italian "Azione", Portuguese "Ação", Japanese "アクション", Simplified Chinese "行动" (with the plural/inflection the language requires). Never render this card type as "spell", "hechizo", "Zauber", "incantesimo", "feitiço", "呪文" or "法术". Playing one is "to play an action" (never "cast"). Inside running text use the language's normal capitalisation (lower case in English, Spanish, Italian, Portuguese; German capitalises nouns); capitalise only at the start of a sentence or a standalone label.
- GLOSSARY — the card type called « objet » in French (an equippable card) is translated EXACTLY as: English "Item", Spanish "Objeto", German "Gegenstand", Italian "Oggetto", Portuguese "Objeto", Japanese "アイテム", Simplified Chinese "物品". Never "object"/"Objekt"/"オブジェクト" for it. Same capitalisation rule as for « action »: lower case in running text (except German nouns).
