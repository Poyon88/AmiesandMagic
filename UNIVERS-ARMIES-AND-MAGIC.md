...
> **La Colère des Flammes** (2026-08-28) : une race, les **Salamandres**, sur le même arbitrage que l'Eau et la Terre — le clan héberge « Élémentaire », donc il garde son corps **1.40/0.75**, le plus offensif du jeu. Son registre est celui de ce qui **survit** au feu là où le clan est celui de ce qui **brûle** : elle repousse (Régénération), elle file (Célérité, Esquive) et elle brûle qui la saisit (Riposte X). Régénération et Esquive montent à 0.55 et 0.45 pour dépasser l'ombrelle (0.35 chacune).

> **Le Souffle des Cimes** (2026-08-28) : deux races, **Sylphes** et **Néphélides**, qui achèvent de peupler les quatre éléments. Même arbitrage — le clan héberge « Élémentaire », donc il garde son corps **1.15/0.85**. **Particularité de ce clan : le générateur accorde le Vol GARANTI à tout ce qui le porte** (`clanId === "Le Souffle des Cimes"`), donc les deux races volent sans rien déclarer — poser `Vol` dans leurs tables serait doublement mort, le clan le portant déjà à 0.80 et la garantie court-circuitant le tirage. Le **Sylphe** se dérobe et échange (Invisible, Permutation, Mimique, Métamorphose) ; la **Néphélide** est l'orage et non la brise (Paralysie, Canalisation, Douleur X).
...
- **Races** : Élémentaire · **Ondins** · **Sirènes** · **Léviathans** *(Eau)* · **Cristallins** · **Troglodytes** · **Bêtes Chtoniennes** *(Terre)* · **Salamandres** *(Feu)* · **Sylphes** · **Néphélides** *(Air)* — *neuf nouvelles races, profils en §4*
- **Clans** : **La Colère des Flammes** (Feu — Élémentaire + Salamandres) · **Le Socle du Monde** (Terre — Élémentaire + Cristallins + Troglodytes + Bêtes Chtoniennes) · **La Vague Sans Fin** (Eau — Élémentaire + Ondins + Sirènes + Léviathans) · **Le Souffle des Cimes** (Air — Élémentaire + Sylphes + Néphélides) — clans à style de combat distinct (voir §5.1). **Les quatre éléments sont désormais peuplés.**
...
- **Races** : Squelettes · Zombies · **Ghoules** · Spectres · Vampires · Lich · Banshees · **Homuncules de Sang** · **Gargouilles** · **Dhampirs** · **Chiroptères** · **Momies** · **Chimères nécrotiques** · **Vermines mortuaires** · **Poltergeists** · **Dullahans** · **Sluaghs** *(onze nouvelles races — profils en §4)*
- **Clans** : **Les Rangs Silencieux** (Squelettes + Zombies + Ghoules), **Le Voile Hurlant** (Spectres + Banshees + Poltergeists + Dullahans + Sluaghs), **La Cour Écarlate** (Vampires + Homuncules de Sang + Gargouilles + Dhampirs + Chiroptères — **le clan le plus peuplé du jeu**), **Le Cénacle Nécromant** (Liches + Momies + Chimères nécrotiques + Vermines mortuaires) — profils distincts en §5.6
- **Philosophie** : Insatiables et corrompus. Résurrection, drain de vie, exploitation du cimetière. Quatre voies : la nuée qui revient sans cesse et dévore, les intangibles qui terrorisent, la cour du sang sous toutes ses formes, les nécromanciens qui recyclent. Poids stats faction (ombrelle) : légèrement offensif (1.05 / 0.95).
...
| Nécropole | **Lich** *(Cénacle Nécromant)* | 0.85 / 1.00 | Savant (0.45), Canalisation (0.45), Divination (0.35) |
| Nécropole | **Momies** *(Cénacle Nécromant)* | 0.90 / 1.25 | Armure (0.60), Malédiction (0.55), Résistance X (0.50), Provocation (0.45), Ancré (0.45), Indestructible (0.30) |
| Nécropole | **Chimères nécrotiques** *(Cénacle Nécromant)* | 1.30 / 1.05 | Fureur (0.60), Régénération (0.55), Double Attaque (0.50), Carnage X (0.45), Persécution X (0.40), Sang mêlé (0.35) |
| Nécropole | **Vermines mortuaires** *(Cénacle Nécromant)* | 0.95 / 0.70 | Poison (0.70), Instinct de meute X (0.65), Nécrophagie (0.60), Convocation X (0.55), Célérité (0.45), Esquive (0.45), Traque (0.35) |
| Nécropole | **Spectres** *(Voile Hurlant)* | 1.05 / 0.75 | Ombre (0.55), Invisible (0.50), Esquive (0.50) |
| Nécropole | **Banshees** *(Voile Hurlant)* | 1.05 / 0.75 | Ombre (0.55), Invisible (0.50), Esquive (0.50) |
...
| Primordiaux | **Salamandres** *(Colère des Flammes)* | *corps du clan (1.40 / 0.75)* | Régénération (0.55), Célérité (0.50), Esquive (0.45), Riposte X (0.40), Première Frappe (0.35), Traque (0.30) |
| Primordiaux | **Sylphes** *(Souffle des Cimes)* | *corps du clan (1.15 / 0.85)* | **Vol garanti par le clan**, Invisible (0.55), Permutation (0.50), Mimique (0.45), Métamorphose (0.40), Contresort (0.35), Précision (0.30) |
| Primordiaux | **Néphélides** *(Souffle des Cimes)* | *corps du clan (1.15 / 0.85)* | **Vol garanti par le clan**, Paralysie (0.55), Canalisation (0.55), Douleur X (0.50), Régénération (0.40), Malédiction (0.40), Bénédiction (0.35) |
...
> **Ghoules** (2026-08-27) : arbitrage **inverse** de celui de la Cour Écarlate, et identique à celui des Nagas. Les Rangs Silencieux gardent leurs `statWeights` — la goule partage donc le corps 1.00/0.90 des Squelettes et des Zombies, et c'est sa table de pouvoirs qui la distingue : elle **court** (Célérité), elle **fige** (Paralysie) et elle **dévore** (Dévoration), là où ses deux voisines recyclent le cimetière. Nécrophagie, sa signature évidente, lui vient du clan (premier poids, 0.55) : la re-déclarer sur la race en ferait une ligne morte.

> **Le Cénacle Nécromant** (2026-08-27) : trois races ajoutées d'un coup — **Momies**, **Chimères nécrotiques**, **Vermines mortuaires** — et le clan **cède ses `statWeights`** à son tour (le **troisième** du jeu, après le Clan des Premiers Géants et La Cour Écarlate). Le critère posé pour les Ghoules — *les races en place ont-elles un profil ?* — se règle ici en **donnant** un profil à **Lich**, recopié au bit près depuis le clan (0.85/1.00 + Savant, Canalisation, Divination) : une liche du Cénacle se génère donc à l'identique. Seule dérive assumée, la même que pour les Vampires : une liche **sans clan** quitte l'ombrelle de faction (1.05/0.95) pour son vrai corps. La table du clan est **ramenée au noyau nécromantique** (Héritage du cimetière, Résurrection, Ombre du passé, Domination) ; sans ce dégraissage, le poids de clan aurait fait de la vermine une érudite. Trois poids de race doivent **dépasser** l'ombrelle pour exister : Poison (0.70 > 0.65), Nécrophagie (0.60 > 0.55) et Convocation X (0.55 > 0.40) chez la vermine, Régénération (0.55 > 0.45) chez la chimère. **Paralysie** irait à la momie mais lui est refusée : elle reste réservée à la **Ghoule**, dont elle est un des trois verbes (courir, figer, dévorer), et un test la verrouille pour toute la Nécropole.
...
| Clan | Race(s) | Style | Identité | Pouvoirs signature |
|---|---|---|---|---|
| ⚰️ **Les Rangs Silencieux** | Squelettes + Zombies + Ghoules | 1.00/0.90 | Nuée increvable, recyclage | Nécrophagie (0.55), Exhumation X (0.55), Rappel (0.50), Convocation X (0.50), Poison (0.40), Sacrifice (0.35), Pacte de sang (0.35) |
| 👻 **Le Voile Hurlant** | Spectres + Banshees + Poltergeists + Dullahans + Sluaghs | *corps de chaque race (§4)* | Le présage de mort | Terreur (0.60), Maléfice (0.45), Malédiction (0.40), Paralysie (0.35) |
...
| 📿 **Le Cénacle Nécromant** | Liches + Momies + Chimères nécrotiques + Vermines mortuaires | *corps de chaque race (§4)* | Nécromanciens, magie du cimetière | Héritage du cimetière (0.55), Résurrection (0.50), Ombre du passé (0.50), Domination (0.40) |
